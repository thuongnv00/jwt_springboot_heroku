...
import com.example.springbootjwtmaven.dto.request.SignInForm;
import com.example.springbootjwtmaven.dto.request.SignUpForm;
import com.example.springbootjwtmaven.dto.response.JwtResponse;
...
import com.example.springbootjwtmaven.security.jwt.JwtProvider;
import com.example.springbootjwtmaven.security.userprincal.UserPrinciple;
import com.example.springbootjwtmaven.service.impl.RoleServiceImpl;
...
public class AuthController {
    ...
    public ResponseEntity<?> register(@Valid @RequestBody SignUpForm signUpForm) {
        if(userService.existsByUsername(signUpForm.getUsername())) {
            return new ResponseEntity<>(new ResponseMessage("The username is exist! Please try again"), HttpStatus.OK);
        }
        if(userService.existsByEmail(signUpForm.getEmail())) {
            return new ResponseEntity<>(new ResponseMessage("Email is exist! Please try again"), HttpStatus.OK);
        }
